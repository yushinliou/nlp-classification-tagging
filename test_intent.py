...
Original file is located at
    https://colab.research.google.com/drive/1atq7M_rOky6xoMSyAxvRFtMe7xTTuK3K
...
# todo 
# https://colab.research.google.com/github/pytorch/tutorials/blob/gh-pages/_downloads/b5fa995b1432ebc93ea7bfe7ec9daed1/text_sentiment_ngrams_tutorial.ipynb#scrollTo=NI7x6gqYeHS1

class SeqClassifier(nn.Module):

    def __init__(self, embeddings, vocab_size, embed_dim, num_class):
        super(SeqClassifier, self).__init__()
        # self.embedding = nn.EmbeddingBag(vocab_size, embed_dim, sparse=False) # old
        # self.embedding = Embedding.from_pretrained(embeddings, freeze=False) # error
